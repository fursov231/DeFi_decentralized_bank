...
contract dBank {
    ...
    function deposit() payable public {
        ...
        require(msg.value >= 1e16, "Error, deposit must be gt 0,01 ETH");
    ...
    function withdraw() public {
        ...
        //31668017 - interest(10 % APY) per second for min. deposit amount (0,01 ETH), eq.
    ...
    function borrow() payable public {
        ...
        require(msg.value >= 1e16, "Error, collateral must be gt 0.01 ETH");
